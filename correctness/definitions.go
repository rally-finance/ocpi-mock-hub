	...
	return SuiteDefinition{
		...
		Actions: []ActionDefinition{
			...
			},
			{
				...
				Description: "Arm the session, then ask the eMSP to push a new Token object.",
				Kind:        "observe",
			},
			{
				...
				Description: "Arm the session, then ask the eMSP to push an update to an existing Token object.",
				Kind:        "observe",
			},
			{
				...
				Description: "Arm the session, then ask the eMSP to invalidate a Token by pushing it again with valid set to false.",
				Kind:        "observe",
			},
			{
				ID:          "run_rta_invalid",
				...
				Description: "Use the discovered Tokens sender endpoint to send an authorization request for an invalid token and validate the peer response.",
				Kind:        "outbound",
			},
			{
				ID:          "run_rta_valid",
				...
				Description: "Use the discovered Tokens sender endpoint to send an authorization request for a known valid token and validate the peer response.",
				Kind:        "outbound",
			},
			{
				ID:          "arm_remote_start",
				...
				Description: "Arm the session, then ask the eMSP to send START_SESSION to the hub.",
				Kind:        "observe",
			},
			{
				ID:          "arm_remote_stop",
